...
const FileToCSV= () => {
    ...
    const onFileChange = e => {
        ...
        // consolsetCSVFile(e.target.files[0])
    }
    ...
    return (
        ...
        <div className=" bg-white shadow-md rounded px-8 py-8 pt-8">
            <div className="pb-4">
                <label htmlFor="file" className="text-sm block font-bold  pb-2">Provide dataset</label>
                <input type="file" accept={'.csv'} name="file"   onChange={onFileChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-blue-300 " placeholder="Enter CSV here"/>
            </div>
